    ...
    while z == True:
        ...
        match x:
            ...
            case 1:
                ...
                name = input('    >>> Nombre: ')
                area = input('    >>> Área: ')
                Paciente.busquedaMedico(name)

                medico_info = objPaciente.busquedaMedico(name)
                
                # Mostrar la información del médico
                if medico_info:
                    print(f"\nInformación del Médico:\nNombre: {medico_info['nombre']}\nApellidos: {medico_info['apellidos']}\nCargo: {medico_info['cargo']}\ncelular: {medico_info['celular']}\nCorreo: {medico_info['correo']}")
                else:
                    print(red('    Médico no encontrado.'))
    ...
    while z == True:
        ...
        match x:
            ...
            case 1:
                ...
                PersonalHospital.busquedaPaciente(nro_doc)

                Paciente_info = objPersonal.busquedaPaciente(nro_doc)
                
                # Mostrar la información del paciente
                if Paciente_info:
                    print(f"\nInformación del Paciente:\nNombre: {Paciente_info['nombre']}\nApellidos: {Paciente_info['apellidos']}\ncelular: {Paciente_info['celular']}\nCorreo: {Paciente_info['correo']}")
                else:
                    print(red('    Paciente no encontrado.'))
                print(cyan(f'\n{'-'*25} Los resultados de su búsqueda {'-'*24}'))
